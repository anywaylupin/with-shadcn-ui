...
export const MenuItem: AceternityComponent<{
...
export const Menu: AceternityComponent<{ setActive: (item: string | null) => void }> = ({ setActive, children }) => (
  <nav
    role="menu"
...
export const ProductItem: AceternityComponent<
  Partial<ImageProps> & { title: string; description: string; href: string; src: string }
> = ({ title, description, href, src, alt, ...rest }) => (
...
export const HoveredLink: AceternityComponent<LinkProps> = ({ children, ...rest }) => (
