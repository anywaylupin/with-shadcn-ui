...
const FloatingDockDesktop = ({ items, className }: PropsWithClass<{ items: FloatingDockItem[] }>) => {
...
type IconContainer = { mouseX: MotionValue; title: string; icon: React.ReactNode; href: string };

const IconContainer = ({ mouseX, title, icon, href }: IconContainer) => {
