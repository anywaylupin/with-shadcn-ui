...
type CoverBeamProps = React.ComponentProps<typeof motion.svg> & {
  delay?: number;
  duration?: number;
  hovered?: boolean;
  width?: number;
...
export const CoverBeam = ({ className, delay, duration, hovered, width = 600, ...svgProps }: CoverBeamProps) => {
  const id = useId();
...
export const CircleIcon = ({ className }: PropsWithClass) => (
  <div
    className={cn(
