...
export const PinContainer: AceternityComponent<PinContainerProps> = ({
  children,
  title,
  href = '/',
  className,
  ...
  return (
    <Link
      ...
      href={href}
    >
      <div className="aceternity-3d-pin absolute left-1/2 top-1/2 mt-4 -translate-x-1/2 -translate-y-1/2">
        <div
          style={{ transform }}
...
export const PinPerspective: AceternityComponent<PinContainerProps> = ({ title }) => (
...
export type PinContainerProps = { title?: string; href?: string };
