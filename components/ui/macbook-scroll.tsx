...
export const MacbookScroll: AceternityComponent<{
  src?: string;
...
export const Lid: AceternityComponent<{
  ...
  <div className="relative [perspective:800px]">
    ...
    <motion.div
      style={{ scaleX, scaleY, rotateX: rotate, translateY: translate, transformOrigin: 'top' }}
      className="absolute inset-0 h-96 w-[32rem] rounded-2xl bg-[#010101] p-2 transform-3d"
    >
...
export const KBtn: AceternityComponent<{
...
export const Row: AceternityComponent = ({ children }) => (
  <div className="mb-[2px] flex w-full flex-shrink-0 gap-[2px]">{children}</div>
);

export const SpeakerGrid: AceternityComponent = () => (
  <div
...
export const OptionKey: AceternityComponent = ({ className }) => (
...
const AceternityLogo: AceternityComponent = () => (
  <svg
    width="66"
    height="65"
    viewBox="0 0 66 65"
