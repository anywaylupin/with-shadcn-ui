...
export const Timeline: AceternityComponent<{
  items: TimelineEntry[];
  title?: StringNode;
  ...
  return (
    <div className="w-full bg-white font-sans md:px-10 dark:bg-neutral-950" ref={containerRef}>
      <div className="mx-auto max-w-7xl px-4 py-20 md:px-8 lg:px-10">
        <h2 className="mb-4 max-w-4xl text-lg text-black md:text-4xl dark:text-white">{title}</h2>
        <p className="max-w-sm text-sm text-neutral-700 md:text-base dark:text-neutral-300">{description}</p>
      </div>
...
type TimelineEntry = { title: string; content: StringNode };
